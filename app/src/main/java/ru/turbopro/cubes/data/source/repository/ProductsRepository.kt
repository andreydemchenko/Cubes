...
import ru.turbopro.cubes.ERR_UPLOAD
...
class ProductsRepository(
	...
	override suspend fun refreshProducts(): StoreProductDataStatus? {
	...
	private suspend fun updateProductsFromRemoteSource(): StoreProductDataStatus? {
		var res: StoreProductDataStatus? = null
		try {
			...
			if (remoteProducts is Success) {
				...
				res = StoreProductDataStatus.DONE
			} else {
				res = StoreProductDataStatus.ERROR
	...
	private suspend fun updateProductFromRemoteSource(productId: String): StoreProductDataStatus? {
		var res: StoreProductDataStatus? = null
		try {
