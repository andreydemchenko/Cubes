...
enum class AddProductItemErrors { ERROR_SIZE, ERROR_COLOR }

enum class AddAchievementItemErrors { ERROR_POINTS, ERROR_IMAGE }

enum class AddEventItemErrors { ERROR_DATE, ERROR_IMAGE }
