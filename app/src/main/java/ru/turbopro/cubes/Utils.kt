...
const val PAYMENT_METHOD_POINTS = "Points"
const val PAYMENT_METHOD_CASH_ON_DELIVERY = "Cash On Delivery"
...
internal fun getEventId(ownerId: String): String {
	val uniqueId = UUID.randomUUID().toString()
	return "event-by-$ownerId-$uniqueId"
}
